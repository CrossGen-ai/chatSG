...
exports.TextProcessorTool = void 0;
const Tool_1 = require("../Tool");
class TextProcessorTool extends Tool_1.BaseTool {
    constructor() {
        super('text-processor', '1.0.0', 'Advanced text processing tool with formatting, analysis, and transformation capabilities', {
            enabled: true,
            timeout: 10000,
            cacheResults: true,
    ...
    async execute(params, context) {
        ...
        try {
            ...
            return this.createErrorResult(`Text processing failed: ${error.message}`);
        }
    }
    capitalizeText(text) {
    ...
    extractEmails(text, limit) {
        const emailRegex = /\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b/g;
        const matches = text.match(emailRegex) || [];
        return limit ? matches.slice(0, limit) : matches;
    }
    extractUrls(text, limit) {
        const urlRegex = /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)/g;
        const matches = text.match(urlRegex) || [];
        return limit ? matches.slice(0, limit) : matches;
    }
    extractNumbers(text, limit) {
    ...
    calculateWordFrequency(text, caseSensitive = false, limit) {
...
exports.TextProcessorTool = TextProcessorTool;
//# sourceMappingURL=TextProcessorTool.js.map