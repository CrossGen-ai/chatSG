...
async function testAgentRouter() {
    ...
    try {
        ...
        runTest('Available Variants Detection', () => {
            ...
            const variants = Object.keys(systemPrompts).filter(variant => variant !== 'blank' && systemPrompts[variant].trim() !== '');
...
//# sourceMappingURL=test-agent-router.js.map