...
class ToolSystemTestUtils {
    static async createTestRegistry() {
        const registry = ToolRegistry_1.ToolRegistry.getInstance();
        await registry.clear();
        return registry;
    }
    static createMockTool(name = 'mock-tool') {
        const tool = new MockTool();
        tool.name = name; // Override name for testing
        return tool;
    }
    static async waitForAsync(ms = 10) {
        return new Promise(resolve => setTimeout(resolve, ms));
    }
    static validateToolResult(result, expectedSuccess = true) {
...
exports.ToolSystemTestUtils = ToolSystemTestUtils;
/**
 * Main test suite
 */
async function runToolSystemTests() {
    ...
    incrementTest(runTest('ToolRegistry Singleton Pattern', () => {
        const registry1 = ToolRegistry_1.ToolRegistry.getInstance();
        const registry2 = ToolRegistry_1.ToolRegistry.getInstance();
    ...
    results.push(await runAsyncTest('Tool Execution via Registry', async () => {
        ...
        const context = { sessionId: 'registry-test' };
...
exports.default = runToolSystemTests;
//# sourceMappingURL=tool-system.test.js.map