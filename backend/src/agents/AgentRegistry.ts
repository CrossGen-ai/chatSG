    ...
    private async discoverLegacyAgents(): Promise<void> {
        ...
        try {
            ...
            try {
                ...
                console.warn('[AgentRegistry] Failed to register AgentZero:', (error as Error).message);
            }
            ...
            try {
                ...
                console.warn('[AgentRegistry] Failed to register AgentRouter:', (error as Error).message);
            }
